...
public interface RedissonClient {
    ...
    /**
     * Returns EfficientMultiLock instance associated with specified <code>group</code> and <code>values</code>
     *
     * @param group the group of values
     * @param values lock values
     * @return BatchLock object
     */
    RLock getEfficientMultiLock(String group, Collection<String> values);
    /*
